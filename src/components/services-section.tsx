...
import { Package, Building, Cog, Archive } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Heavy-duty pallet racking solutions designed for maximum storage efficiency and safety compliance.",
    ...
    },
    {
      ...
      description: "Advanced automation systems to streamline your warehouse operations and increase productivity.",
